...
/***/ function(module, exports, __webpack_require__) {
	...
	function animate(tile, _start, _dest, canvas, width) {
	  var j = _start[1];
	  var i = _start[0];
	  if (tile) {
	    var match = tile[0];
	    ...
	    var ti = match[0];
	    var step = [0];
	    var dx = [Caml_int32.imul(i, width)];
	    var dy = [Caml_int32.imul(j, width)];
	    var deltaX = Caml_int32.imul(_dest[0] - i | 0, width) / 10 | 0;
	    var deltaY = Caml_int32.imul(_dest[1] - j | 0, width) / 10 | 0;
	    var drawStep = function () {
	      if (step[0] < 10) {
	        Canvas$Fifteen.clearRect(canvas, dx[0], dy[0], width, width);
	        step[0] = step[0] + 1 | 0;
	        dx[0] = Caml_int32.imul(i, width) + Caml_int32.imul(step[0], deltaX) | 0;
	        dy[0] = Caml_int32.imul(j, width) + Caml_int32.imul(step[0], deltaY) | 0;
	        Canvas$Fifteen.drawImage(canvas, Caml_int32.imul(ti, width), Caml_int32.imul(tj, width), dx[0], dy[0], width);
	    ...
	    return Pervasives.failwith("Tile.animate: hole tile");
	  }
	}
	...
	function draw(b, cvs) {
	  return Belt_Array.forEachWithIndex(b, (function (i, t) {
	                ...
	                if (tile) {
	                  var match = tile[0];
	                  return Canvas$Fifteen.drawImage(canvas, Caml_int32.imul(match[0], width$1), Caml_int32.imul(match[1], width$1), Caml_int32.imul(param[0], width$1), Caml_int32.imul(param[1], width$1), width$1);
	                } else {
	                  return /* () */0;
	                }
	              }));
	...
	function click(param, b, cvs) {
	  var match = toTileC(/* tuple */[
	        param[0],
	        param[1]
	      ]);
	  var j = match[1];
	  ...
	  if (Belt_List.some(swapable(b), (function (i) {
	    ...
	    animate(Caml_array.caml_array_get(b, idx), /* tuple */[
	          i,
	          j
	        ], toCoords(holeIdx(b)), cvs, width);
	    return swap(idx, holeIdx(b), b);
	  } else {
	    return b;
	  }
	}
...
/***/ function(module, exports) {
	...
	function clearRect(param, x, y, width, height) {
	  param[1].clearRect(x, y, width, height);
	  return /* () */0;
	}
